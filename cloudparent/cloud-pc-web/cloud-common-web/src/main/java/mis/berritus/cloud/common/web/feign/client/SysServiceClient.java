...
import mis.berritus.cloud.common.web.feign.client.fallback.SysServiceClientFallback;
 ...
 * @Date: 2019/7/14
 */
@FeignClient(value = "cloud-sys-service", fallback = SysServiceClientFallback.class, configuration = DefaultFeignConfig.class)
